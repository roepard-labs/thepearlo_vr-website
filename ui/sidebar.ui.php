    ...
    <div class="sidebar-content h-100 d-flex flex-column">
        ...
        <nav class="sidebar-nav flex-grow-1 p-3">
            <ul class="nav flex-column gap-2">
                ...
                <li class="nav-item admin-only" data-admin-only="true" style="display: none;" aria-hidden="true">
                    <a href="/dashboard/users" class="nav-link sidebar-link" data-page="users"
                        title="Gestión de Usuarios" tabindex="-1">
                ...
                <!-- Configuración (admin only) - oculto por defecto en HTML; JS mostrará si RoleService confirma admin -->
                <li class="nav-item admin-only" data-admin-only="true" style="display: none;" aria-hidden="true">
                    <a href="/dashboard/settings" class="nav-link sidebar-link" data-page="settings" tabindex="-1"
                        title="Configuración">
    ...
    <div class="offcanvas-body p-0">
        <nav class="p-3">
            <ul class="nav flex-column gap-2">
                ...
                <!-- Configuración (admin only) - oculto por defecto en HTML; JS mostrará si RoleService confirma admin -->
                <li class="nav-item admin-only" data-admin-only="true" style="display: none;" aria-hidden="true">
                    <a href="/dashboard/settings" class="nav-link sidebar-link" tabindex="-1">
                        <i class="bx bx-cog me-3"></i>
